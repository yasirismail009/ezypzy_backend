...
__all__ = [
    'ReferencesEvents', 'vbextFileTypeProject', '_CodePane',
    'vbext_vm_Break', '_Properties', '_dispReferencesEvents',
    'vbextFileTypeModule', 'vbextFileTypeDesigners',
    'vbext_vm_Design', 'vbext_cv_ProcedureView', '_VBComponents',
    'vbext_wt_ToolWindow', 'vbext_wt_Toolbox', '_AddIns', '_Windows',
    '_VBComponent', 'vbext_rk_TypeLib', '_dispVBComponentsEvents',
    'vbext_ws_Normal', 'vbext_ProcKind', '_Windows_old',
    '_VBProjects', '_dispVBProjectsEvents', 'vbextFileTypeExe',
    'Property', 'Properties', '_dispReferences_Events', '_VBProject',
    '_CommandBarControlEvents', 'vbext_wt_Watch',
    'vbext_ct_ActiveXDesigner', 'vbext_ws_Minimize',
    'vbext_wt_Locals', 'vbext_wt_ProjectWindow', '_CodeModule',
    'VBComponents', 'vbext_ct_ClassModule', 'vbext_pp_locked',
    'vbext_RefKind', '_VBComponent_Old', 'CommandBarEvents',
    'vbext_ComponentType', '_ReferencesEvents', 'vbext_pp_none',
    'Addins', 'CodeModule', 'vbext_CodePaneview', 'vbext_wt_Browser',
    'vbext_pt_StandAlone', 'vbext_wt_MainWindow', 'vbext_ct_MSForm',
    'Reference', 'Windows', 'vbext_ProjectType', 'vbext_WindowType',
    'CodePanes', 'Events', 'VBE', 'vbext_ws_Maximize',
    'vbextFileTypeForm', 'vbext_rk_Project', 'vbext_wt_Find',
    '_LinkedWindows', '_VBComponentsEvents', 'vbext_ct_Document',
    'vbext_VBAMode', 'AddIn', 'vbextFileTypeClass', 'VBProjects',
    'vbext_pk_Let', 'ProjectTemplate', 'vbext_vm_Run', 'VBComponent',
    'vbextFileTypeBinary', '_Components', 'vbextFileTypeDocObject',
    'vbextFileTypeUserControl', 'Window',
    'vbext_wt_LinkedWindowFrame', 'Component', 'vbext_WindowState',
    'vbextFileTypeFrx', 'vbextFileTypePropertyPage',
    'vbext_wt_Designer', 'vbextFileTypeRes', '_VBProject_Old',
    'vbext_wt_FindReplace', 'VBProject', 'vbext_ct_StdModule',
    '_dispCommandBarControlEvents', 'Components', 'Application',
    '_References', '_Component', 'CodePane',
    'vbextFileTypeGroupProject', 'vbext_wt_CodeWindow',
    'vbext_ProjectProtection', 'SelectedComponents',
    '_VBComponents_Old', 'vbextFileTypes', 'vbext_cv_FullModuleView',
    'vbext_wt_PropertyWindow', '_VBProjects_Old', '_VBProjectsEvents',
    '_CodePanes', 'vbext_wt_Immediate', 'vbext_pk_Set',
    'vbext_pk_Proc', 'References', 'vbext_pk_Get', 'LinkedWindows',
    '_ProjectTemplate', 'vbext_pt_HostProject'
]

_check_version('1.2.0', 1348956714.000000)
